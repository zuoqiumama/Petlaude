...
const SCHEMA = {
  ...
  // Auto-fetch model pricing (LiteLLM + OpenRouter) at runtime. New key in v9;
  // old prefs files default it on via validate() — no version-gated backfill needed.
  pricingAutoFetch: { type: "boolean", default: true },
