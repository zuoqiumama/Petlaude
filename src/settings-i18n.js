...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      sidebarStudio: "AI Studio",
      studioIntro: "Generate companion animations for your own pet from one reference image. Configure an OpenAI-compatible image API, pick a reference, then generate all actions or just one.",
      studioApiSection: "Image API",
      studioBaseUrl: "Base URL",
      studioModel: "Model",
      studioApiKey: "API key",
      studioApiKeySaved: "(saved — leave blank to keep)",
      studioKeyNotPersisted: "Saved. Key kept in memory only (OS encryption unavailable).",
      studioSaved: "Saved.",
      studioSave: "Save",
      studioTest: "Test",
      studioTestOk: "Connection OK",
      studioTestFailed: "Connection failed",
      studioReferenceSection: "Pet Reference",
      studioPetName: "Pet name",
      studioPetNamePlaceholder: "My Pet",
      studioPickImage: "Choose image…",
      studioUseCurrentPet: "Use current pet",
      studioNoReference: "No image selected",
      studioActionsSection: "Actions",
      studioGenerateAll: "Generate all",
      studioGenerating: "Generating…",
      studioGenerate: "Generate",
      studioRegenerate: "Regenerate",
      studioPreviewPending: "Preview appears after generation",
      studioPreviewAlt: "action preview",
      studioStatusDone: "Done",
      studioStatusFailed: "Failed",
      studioPartialDone: "Finished with some failures",
      studioStoppedEarly: "Stopped early to avoid wasting API credits — the provider's output keeps failing quality checks.",
      studioDoneSwitchHint: "Generated! Switch to your pet in the Theme tab.",
      studioConfigIncomplete: "Save the API config and choose a reference image first.",
      studioCatCore: "Core states",
      studioCatSleep: "Sleep sequence",
      studioCatMini: "Mini mode (edge peek)",
      studioCatIdle: "Idle life",
      studioCatContext: "Context reactions",
      studioCatTouch: "Touch reactions",
      ...
      sectionPetClickAction: "Double-click action",
      sectionStartup: "Startup",
      sectionBubbles: "Bubbles",
      sectionPricing: "Model pricing",
      rowPricingAutoFetch: "Auto-fetch model pricing",
      rowPricingAutoFetchDesc: "Update prices from LiteLLM + OpenRouter on launch and once a day. Your curated overrides always win.",
      actionPricingRefresh: "Refresh now",
      rowPricingLastUpdated: "Updated",
      rowPricingStatusNever: "Not updated yet",
      rowPricingRefreshing: "Refreshing…",
      ...
      rowAppearanceMode: "Theme",
      rowAppearanceModeDesc: "Switch between light, dark, or follow system theme.",
      ...
      rowPetClickAction: "Double-click pet to open default app",
      rowPetClickActionDesc: "Double-click opens your chosen executable and keeps the existing pet reaction. Single click still shows the Session HUD.",
      rowPetClickExecutable: "Default executable",
      rowPetClickExecutableDesc: "Choose codex, claude, an editor, or any executable file.",
      rowPetClickWorkspace: "Default workspace",
      rowPetClickWorkspaceDesc: "Optional. CLI agents start in this folder when Terminal mode is used.",
      rowPetClickLaunchMode: "Launch mode",
      rowPetClickLaunchModeDesc: "Terminal is best for CLI agents; Direct is best for GUI apps.",
      actionChoose: "Choose",
      actionClear: "Clear",
      valueNotSet: "Not set",
      ...
      themeStudioActionsIncomplete: (done, total) => `Actions incomplete ${done}/${total}`,
      ...
      animOverridesSectionIdleLife: "Idle life",
      animOverridesSectionContext: "Context reactions",
      ...
      animReactionRapidClick: "Rapid poke (6+)",
      animReactionDragRelease: "Drop (after drag)",
    ...
    zh: {
      ...
      sidebarStudio: "AI 工作室",
      studioIntro: "用一张参考图为你自己的宠物生成全套陪伴动画。配置 OpenAI 兼容的生图 API，选择参考图，然后一键生成全部动作或单独生成某个动作。",
      studioApiSection: "生图 API",
      studioBaseUrl: "Base URL",
      studioModel: "模型",
      studioApiKey: "API 密钥",
      studioApiKeySaved: "（已保存——留空表示保持不变）",
      studioKeyNotPersisted: "已保存。密钥仅保留在内存中（系统加密不可用）。",
      studioSaved: "已保存。",
      studioSave: "保存",
      studioTest: "测试",
      studioTestOk: "连接正常",
      studioTestFailed: "连接失败",
      studioReferenceSection: "宠物参考图",
      studioPetName: "宠物名称",
      studioPetNamePlaceholder: "我的宠物",
      studioPickImage: "选择图片…",
      studioUseCurrentPet: "使用当前宠物形象",
      studioNoReference: "未选择图片",
      studioActionsSection: "动作",
      studioGenerateAll: "一键生成全部",
      studioGenerating: "生成中…",
      studioGenerate: "生成",
      studioRegenerate: "重新生成",
      studioPreviewPending: "生成后显示预览",
      studioPreviewAlt: "动作预览",
      studioStatusDone: "完成",
      studioStatusFailed: "失败",
      studioPartialDone: "完成，但有部分失败",
      studioStoppedEarly: "已提前停止以免继续浪费 API 费用 —— 供应商出图一直通不过质量校验。",
      studioDoneSwitchHint: "生成完毕！在「主题」标签页切换到你的宠物。",
      studioConfigIncomplete: "请先保存 API 配置并选择参考图。",
      studioCatCore: "核心状态",
      studioCatSleep: "睡眠序列",
      studioCatMini: "迷你模式（边缘探头）",
      studioCatIdle: "闲置小动作",
      studioCatContext: "情境反应",
      studioCatTouch: "触摸反应",
      ...
      sectionSession: "会话管理",
      sectionPetClickAction: "双击桌宠",
      sectionStartup: "启动",
      sectionBubbles: "气泡",
      sectionPricing: "模型定价",
      rowPricingAutoFetch: "自动获取模型定价",
      rowPricingAutoFetchDesc: "启动时与每日从 LiteLLM + OpenRouter 更新价格；你的 curated 覆盖始终优先。",
      actionPricingRefresh: "立即刷新",
      rowPricingLastUpdated: "上次更新",
      rowPricingStatusNever: "尚未更新",
      rowPricingRefreshing: "刷新中…",
      hardwareBuddyTitle: "Hardware Buddy",
      ...
      rowAppearanceMode: "主题",
      rowAppearanceModeDesc: "切换浅色、深色模式，或跟随系统主题。",
      ...
      rowPetClickAction: "双击桌宠打开默认程序",
      rowPetClickActionDesc: "双击会打开你选择的可执行文件，并保留现有桌宠反应。单击仍然显示会话 HUD。",
      rowPetClickExecutable: "默认可执行文件",
      rowPetClickExecutableDesc: "可选择 codex、claude、编辑器或任何可执行文件。",
      rowPetClickWorkspace: "默认工作空间",
      rowPetClickWorkspaceDesc: "可选。使用终端模式时，CLI agent 会从这个目录启动。",
      rowPetClickLaunchMode: "启动模式",
      rowPetClickLaunchModeDesc: "CLI agent 推荐终端模式；GUI 应用推荐直接模式。",
      actionChoose: "选择",
      actionClear: "清空",
      valueNotSet: "未设置",
      rowOpenAtLogin: "开机自启",
      ...
      themeStudioActionsIncomplete: (done, total) => `动作不完整 ${done}/${total}`,
      ...
      animOverridesSectionIdleLife: "闲置小动作",
      animOverridesSectionContext: "情境反应",
      ...
      animReactionRapidClick: "狂戳（6+）",
      animReactionDragRelease: "拖拽松手",
    ...
    "zh-TW": {
      ...
      sidebarStudio: "AI 工作室",
      studioIntro: "用一張參考圖為你的寵物產生全套陪伴動畫。設定 OpenAI 相容的生圖 API，選擇參考圖，然後一鍵產生全部動作或單獨產生某個動作。",
      studioApiSection: "生圖 API",
      studioBaseUrl: "Base URL",
      studioModel: "模型",
      studioApiKey: "API 金鑰",
      studioApiKeySaved: "（已儲存——留空表示保持不變）",
      studioKeyNotPersisted: "已儲存。金鑰僅保留在記憶體中（系統加密不可用）。",
      studioSaved: "已儲存。",
      studioSave: "儲存",
      studioTest: "測試",
      studioTestOk: "連線正常",
      studioTestFailed: "連線失敗",
      studioReferenceSection: "寵物參考圖",
      studioPetName: "寵物名稱",
      studioPetNamePlaceholder: "我的寵物",
      studioPickImage: "選擇圖片…",
      studioUseCurrentPet: "使用目前寵物形象",
      studioNoReference: "未選擇圖片",
      studioActionsSection: "動作",
      studioGenerateAll: "一鍵產生全部",
      studioGenerating: "產生中…",
      studioGenerate: "產生",
      studioRegenerate: "重新產生",
      studioPreviewPending: "產生後顯示預覽",
      studioPreviewAlt: "動作預覽",
      studioStatusDone: "完成",
      studioStatusFailed: "失敗",
      studioPartialDone: "完成，但有部分失敗",
      studioStoppedEarly: "已提前停止以免繼續浪費 API 費用 —— 供應商出圖一直通不過品質校驗。",
      studioDoneSwitchHint: "產生完畢！請在「主題」分頁切換到你的寵物。",
      studioConfigIncomplete: "請先儲存 API 設定並選擇參考圖。",
      studioCatCore: "核心狀態",
      studioCatSleep: "睡眠序列",
      studioCatMini: "迷你模式（邊緣探頭）",
      studioCatIdle: "閒置小動作",
      studioCatContext: "情境反應",
      studioCatTouch: "觸摸反應",
      ...
      sectionPetClickAction: "雙擊桌寵",
      sectionStartup: "啟動",
      sectionBubbles: "對話框",
      sectionPricing: "模型定價",
      rowPricingAutoFetch: "自動取得模型定價",
      rowPricingAutoFetchDesc: "啟動時與每日從 LiteLLM + OpenRouter 更新價格；你的 curated 覆寫永遠優先。",
      actionPricingRefresh: "立即重新整理",
      rowPricingLastUpdated: "上次更新",
      rowPricingStatusNever: "尚未更新",
      rowPricingRefreshing: "更新中…",
      hardwareBuddyTitle: "Hardware Buddy",
      ...
      rowAppearanceMode: "主題",
      rowAppearanceModeDesc: "切換淺色、深色模式，或跟隨系統主題。",
      ...
      rowPetClickAction: "雙擊桌寵開啟預設程式",
      rowPetClickActionDesc: "雙擊會開啟你選擇的可執行檔，並保留現有桌寵反應。單擊仍會顯示工作階段 HUD。",
      rowPetClickExecutable: "預設可執行檔",
      rowPetClickExecutableDesc: "可選擇 codex、claude、編輯器或任何可執行檔。",
      rowPetClickWorkspace: "預設工作空間",
      rowPetClickWorkspaceDesc: "選填。使用終端機模式時，CLI agent 會從此資料夾啟動。",
      rowPetClickLaunchMode: "啟動模式",
      rowPetClickLaunchModeDesc: "CLI agent 建議使用終端機模式；GUI 應用程式建議使用直接模式。",
      actionChoose: "選擇",
      actionClear: "清除",
      valueNotSet: "未設定",
      ...
      themeStudioActionsIncomplete: (done, total) => `動作不完整 ${done}/${total}`,
      ...
      animOverridesSectionIdleLife: "閒置小動作",
      animOverridesSectionContext: "情境反應",
    ...
    ko: {
      ...
      sidebarStudio: "AI 스튜디오",
      studioIntro: "참고 이미지 한 장으로 나만의 펫 동반 애니메이션을 생성합니다. OpenAI 호환 이미지 API를 설정하고 참고 이미지를 선택한 뒤, 모든 동작을 한 번에 또는 개별로 생성하세요.",
      studioApiSection: "이미지 API",
      studioBaseUrl: "Base URL",
      studioModel: "모델",
      studioApiKey: "API 키",
      studioApiKeySaved: "(저장됨 — 비워 두면 유지)",
      studioKeyNotPersisted: "저장됨. 키는 메모리에만 보관됩니다(OS 암호화 사용 불가).",
      studioSaved: "저장되었습니다.",
      studioSave: "저장",
      studioTest: "테스트",
      studioTestOk: "연결 정상",
      studioTestFailed: "연결 실패",
      studioReferenceSection: "펫 참고 이미지",
      studioPetName: "펫 이름",
      studioPetNamePlaceholder: "내 펫",
      studioPickImage: "이미지 선택…",
      studioUseCurrentPet: "현재 펫 사용",
      studioNoReference: "선택된 이미지 없음",
      studioActionsSection: "동작",
      studioGenerateAll: "모두 생성",
      studioGenerating: "생성 중…",
      studioGenerate: "생성",
      studioRegenerate: "다시 생성",
      studioPreviewPending: "생성 후 미리보기 표시",
      studioPreviewAlt: "동작 미리보기",
      studioStatusDone: "완료",
      studioStatusFailed: "실패",
      studioPartialDone: "일부 실패와 함께 완료",
      studioStoppedEarly: "API 비용 낭비를 막기 위해 조기 중단했습니다 — 제공자 출력이 품질 검사를 계속 통과하지 못합니다.",
      studioDoneSwitchHint: "생성 완료! 테마 탭에서 펫으로 전환하세요.",
      studioConfigIncomplete: "먼저 API 설정을 저장하고 참고 이미지를 선택하세요.",
      studioCatCore: "기본 상태",
      studioCatSleep: "수면 시퀀스",
      studioCatMini: "미니 모드(가장자리 엿보기)",
      studioCatIdle: "대기 동작",
      studioCatContext: "상황 반응",
      studioCatTouch: "터치 반응",
      ...
      sectionPetClickAction: "펫 더블클릭 동작",
      sectionStartup: "시작",
      sectionBubbles: "말풍선",
      sectionPricing: "모델 가격",
      rowPricingAutoFetch: "모델 가격 자동 가져오기",
      rowPricingAutoFetchDesc: "시작 시와 하루에 한 번 LiteLLM + OpenRouter에서 가격을 업데이트합니다. 사용자 지정 재정의가 항상 우선합니다.",
      actionPricingRefresh: "지금 새로고침",
      rowPricingLastUpdated: "업데이트됨",
      rowPricingStatusNever: "아직 업데이트되지 않음",
      rowPricingRefreshing: "새로고침 중…",
      hardwareBuddyTitle: "Hardware Buddy",
      ...
      rowAppearanceMode: "테마",
      rowAppearanceModeDesc: "라이트, 다크 모드를 전환하거나 시스템 테마를 따릅니다.",
      ...
      rowPetClickAction: "펫 더블클릭 시 기본 앱 열기",
      rowPetClickActionDesc: "더블클릭하면 선택한 실행 파일을 열고 기존 펫 반응도 유지합니다. 단일 클릭은 계속 세션 HUD를 표시합니다.",
      rowPetClickExecutable: "기본 실행 파일",
      rowPetClickExecutableDesc: "codex, claude, 에디터 또는 실행 파일을 선택합니다.",
      rowPetClickWorkspace: "기본 작업 공간",
      rowPetClickWorkspaceDesc: "선택 사항입니다. 터미널 모드에서는 CLI 에이전트가 이 폴더에서 시작됩니다.",
      rowPetClickLaunchMode: "실행 모드",
      rowPetClickLaunchModeDesc: "CLI 에이전트에는 터미널 모드, GUI 앱에는 직접 모드가 적합합니다.",
      actionChoose: "선택",
      actionClear: "지우기",
      valueNotSet: "설정 안 됨",
      ...
      themeStudioActionsIncomplete: (done, total) => `동작 미완성 ${done}/${total}`,
      ...
      animOverridesSectionIdleLife: "대기 동작",
      animOverridesSectionContext: "상황 반응",
      ...
      animReactionRapidClick: "빠르게 찌르기(6+)",
      animReactionDragRelease: "드래그 후 놓기",
    ...
    ja: {
      ...
      sidebarStudio: "AI スタジオ",
      studioIntro: "1枚の参照画像から自分のペットのコンパニオンアニメーションを生成します。OpenAI 互換の画像 API を設定し、参照画像を選んで、全アクションを一括生成または個別生成できます。",
      studioApiSection: "画像 API",
      studioBaseUrl: "Base URL",
      studioModel: "モデル",
      studioApiKey: "API キー",
      studioApiKeySaved: "（保存済み — 空欄のままなら維持）",
      studioKeyNotPersisted: "保存しました。キーはメモリ内のみ保持されます（OS 暗号化が利用不可）。",
      studioSaved: "保存しました。",
      studioSave: "保存",
      studioTest: "テスト",
      studioTestOk: "接続 OK",
      studioTestFailed: "接続失敗",
      studioReferenceSection: "ペット参照画像",
      studioPetName: "ペット名",
      studioPetNamePlaceholder: "マイペット",
      studioPickImage: "画像を選択…",
      studioUseCurrentPet: "現在のペットを使う",
      studioNoReference: "画像未選択",
      studioActionsSection: "アクション",
      studioGenerateAll: "一括生成",
      studioGenerating: "生成中…",
      studioGenerate: "生成",
      studioRegenerate: "再生成",
      studioPreviewPending: "生成後にプレビューを表示",
      studioPreviewAlt: "アクションプレビュー",
      studioStatusDone: "完了",
      studioStatusFailed: "失敗",
      studioPartialDone: "一部失敗で完了",
      studioStoppedEarly: "APIコストの浪費を防ぐため早期に停止しました — プロバイダーの出力が品質チェックを通過しません。",
      studioDoneSwitchHint: "生成完了！テーマタブでペットに切り替えてください。",
      studioConfigIncomplete: "先に API 設定を保存し、参照画像を選択してください。",
      studioCatCore: "コアステート",
      studioCatSleep: "スリープシーケンス",
      studioCatMini: "ミニモード（端のぞき）",
      studioCatIdle: "アイドル動作",
      studioCatContext: "コンテキスト反応",
      studioCatTouch: "タッチ反応",
      ...
      sectionPetClickAction: "ペットダブルクリック動作",
      sectionStartup: "起動",
      sectionBubbles: "吹き出し",
      sectionPricing: "モデル料金",
      rowPricingAutoFetch: "モデル料金を自動取得",
      rowPricingAutoFetchDesc: "起動時と1日1回、LiteLLM + OpenRouter から料金を更新します。カスタム上書きが常に優先されます。",
      actionPricingRefresh: "今すぐ更新",
      rowPricingLastUpdated: "最終更新",
      rowPricingStatusNever: "未更新",
      rowPricingRefreshing: "更新中…",
      hardwareBuddyTitle: "Hardware Buddy",
      ...
      rowAppearanceMode: "テーマ",
      rowAppearanceModeDesc: "ライト・ダークモードを切り替え、またはシステムテーマに従います。",
      ...
      rowPetClickAction: "ペットのダブルクリックで既定アプリを開く",
      rowPetClickActionDesc: "ダブルクリックで選択した実行ファイルを開き、既存のペット反応も維持します。シングルクリックは引き続きセッション HUD を表示します。",
      rowPetClickExecutable: "既定の実行ファイル",
      rowPetClickExecutableDesc: "codex、claude、エディタ、または任意の実行ファイルを選択します。",
      rowPetClickWorkspace: "既定のワークスペース",
      rowPetClickWorkspaceDesc: "任意。ターミナルモードでは CLI エージェントがこのフォルダから起動します。",
      rowPetClickLaunchMode: "起動モード",
      rowPetClickLaunchModeDesc: "CLI エージェントにはターミナルモード、GUI アプリには直接モードが適しています。",
      actionChoose: "選択",
      actionClear: "クリア",
      valueNotSet: "未設定",
      ...
      themeStudioActionsIncomplete: (done, total) => `アクション未完成 ${done}/${total}`,
      ...
      animOverridesSectionIdleLife: "アイドル動作",
      animOverridesSectionContext: "コンテキスト反応",
      ...
      animReactionRapidClick: "連打（6+）",
      animReactionDragRelease: "ドラッグ後に離す",
